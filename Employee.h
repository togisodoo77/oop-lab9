      ...
      division(nullptr)
{
    ...
    cout << "    " << left << setw(18) << "Company ID" << ": " << CompanyID << endl;
    cout << "    " << left << setw(18) << "Title" << ": " << Title << endl;
    cout << "    " << left << setw(18) << "Start Date" << ": " << StartDate << endl;
    ...
    for (int i = 0; i < jobDescriptions.size(); i++) {
        cout << "  " << i + 1 << ". "
             << jobDescriptions[i]->getDescription() << endl;
    }
